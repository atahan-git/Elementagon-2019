...
public class DoranCustomScript : MonoBehaviour {
	...
	public DialogTreeAsset doranLevelAlreadyDoneDialog;
	...
	void LateStartChangeDialog () {
		DialogTree.s.LoadFromAsset (doranLevelAlreadyDoneDialog);
	...
	public void ActivateEarth () {
		...
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, 14, 4, 1, PowerUpManager.s.dragonColors[2]);
	...
	public void ChoosePower (int id) {
		...
		//quest save
		SaveMaster.s.mySave.questDecisions[1] = id;
