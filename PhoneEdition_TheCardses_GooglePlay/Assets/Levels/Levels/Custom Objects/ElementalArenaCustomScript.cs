...
public class ElementalArenaCustomScript : MonoBehaviour {
	...
	public void ActivateEarth () {
		...
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, CharacterStuffController.s.ConverElementToType (0), 4, 1, PowerUpManager.s.dragonColors[1]);
	}

	public void ActivateFire () {
		DataLogger.LogMessage ("Activating fire");
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, CharacterStuffController.s.ConverElementToType (1), 4, 1, PowerUpManager.s.dragonColors[2]);
	}
	
	public void ActivateIce () {
		DataLogger.LogMessage ("Activating ice");
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, CharacterStuffController.s.ConverElementToType (2), 4, 1, PowerUpManager.s.dragonColors[3]);
	}

	public void ActivateLight () {
		DataLogger.LogMessage ("Activating light");
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, CharacterStuffController.s.ConverElementToType (3), 4, 1, PowerUpManager.s.dragonColors[4]);
	}

	public void ActivateNether () {
		DataLogger.LogMessage ("Activating nether");
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, CharacterStuffController.s.ConverElementToType (4), 4, 1, PowerUpManager.s.dragonColors[5]);
	}

	public void ActivatePoison () {
		DataLogger.LogMessage ("Activating poison");
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, CharacterStuffController.s.ConverElementToType (5), 4, 1, PowerUpManager.s.dragonColors[6]);
	}

	public void ActivateShadow () {
		DataLogger.LogMessage ("Activating shadow");
		PowerUpManager.s.EnablePowerUp (PowerUpManager.PUpTypes.equipment, CharacterStuffController.s.ConverElementToType (6), 4, 1, PowerUpManager.s.dragonColors[7]);
	}
